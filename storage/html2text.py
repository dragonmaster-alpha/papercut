...
class HTML2Text(HTMLParser.HTMLParser):
    def __init__(self, out=None, baseurl=''):
        ...
        self.leave_newline = LEAVE_NEWLINE
    ...
    def o(self, data, puredata=0, force=0):
        ...
        if not self.quiet:
            if self.google_doc:
                ...
                if self.leave_newline:
                    lstripped_data = data.lstrip(' \t\f\v')
                else:
...
def main():
    ...
    p.add_option("-n", "--leave-newline", dest="leave_newline", action="store_true",
        default=LEAVE_NEWLINE, help="leave newline characters")
    ...
    h.leave_newline = options.leave_newline
